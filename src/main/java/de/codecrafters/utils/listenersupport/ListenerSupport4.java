...
public final class ListenerSupport4<L, A1, A2, A3, A4> extends ListenerSupportBase<L> {
    ...
    /**
     * Creates a new ListenerSupport that uses the given {@link ListenerSupport4.ListenerNotifier} and the given {@link Executor}.
     *
     * @param notifier       The {@link ListenerSupport4.ListenerNotifier} that shall be used to notify the listeners.
